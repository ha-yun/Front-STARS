    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-6">
                {editMode ? (
                    <button
                        className="w-full sm:w-auto bg-gray-500 text-white py-2 px-6 rounded-lg hover:bg-gray-600 transition-colors flex-1 sm:flex-none flex items-center justify-center"
